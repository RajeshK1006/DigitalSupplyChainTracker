package com.supplytracker.AlertsModule;
...
public class AlertServiceTest {
    ...
    public void testGetAllAlerts() {
        ...
        assertEquals(AlertType.DELAY, AlertType.valueOf(result.get(0).getType()));
    }
    ...
    public void testGetAlertById_Found() {
        ...
        assertEquals(AlertType.DAMAGE, AlertType.valueOf(dto.getType()));
    }
